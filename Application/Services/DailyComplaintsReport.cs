...
namespace WebAPI.Application.Services
{
        ...
        public class DailyComplaintsReport : IDocument
        {
            private readonly List<DailyComplaintReportDto> _complaints;

            public DailyComplaintsReport(List<DailyComplaintReportDto> complaints)
            {
            ...
            public void Compose(IDocumentContainer container)
            {
                container.Page(page =>
                {
                    ...
                    page.Header().Text("Daily Complaints Report")
                        .FontSize(20)
                        .Bold()
                        .AlignCenter();
